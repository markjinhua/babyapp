/// CHAT GPT ID
String openAiToken = "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";
...
const String weekPlanAndroid = 'storeKeySubscription'; /// ENTER YOUR ONE WEEK  PLAN ID
const String yearPlanAndroid = 'storeKeySubscription'; /// ENTER YOUR ONE YEAR PLAN ID

/// IN APP PURCHASE ID(IOS)
const String monthPlanIOS = 'android.test.purchased'; /// ENTER YOUR ONE MONTH PLAN ID
